...
panelProgram <- function() {
    shiny::div("",
        ...
        years of age (and the number of positive tests). The required columsn are:"),
        shiny::tags$ul(
            shiny::HTML("<li><strong>Country</strong>"),
            shiny::HTML("<li><strong>Year</strong>"),
            ...
            shiny::HTML("<li><strong>Age Group</strong>"),
            shiny::HTML("<li><strong>Sex</strong>"),
            shiny::HTML("<li><strong>HIV Status</strong>")
        ),
        shiny::span("*A person should only be counted as testing once even if up to three different assays are performed to confirm an HIV-positive diagnosis according to the national testing algorithm.
