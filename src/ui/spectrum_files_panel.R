        ...
        shiny::conditionalPanel(condition = "output.anySpectrumDataSets",
            ...
            shiny::div("",
                ...
                shiny::tabsetPanel(
                    ...
                    shiny::div("", class = "row",
                        shiny::div("", class = "col-md-6 col-sm-12", shinycssloaders::withSpinner(plotOutput(outputId = "spectrumPrevalence"))),
                        shiny::div("", class = "col-md-6 col-sm-12", shinycssloaders::withSpinner(plotOutput(outputId = "spectrumIncidence")))
                    ),
                    shiny::div("", class = "row",
                        shiny::div("", class = "col-md-6 col-sm-12", shinycssloaders::withSpinner(plotOutput(outputId = "spectrumTotalPop"))),
                        shiny::div("", class = "col-md-6 col-sm-12", shinycssloaders::withSpinner(plotOutput(outputId = "spectrumPLHIV")))
                    )
                    ),
                    shiny::tabPanel("Data",
